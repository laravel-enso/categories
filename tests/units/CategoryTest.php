...
class CategoryTest extends TestCase
{
    ...
    {
        $this->assertEquals([1, 2, 3], $this->parent->flattenCurrentAndBelow()->toArray());
        $this->assertEquals([2, 3], $this->middle->flattenCurrentAndBelow()->toArray());
        $this->assertEquals([3], $this->leaf->flattenCurrentAndBelow()->toArray());
    }
